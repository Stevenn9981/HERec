...
nohup python -u HERec_spl.py --um +ucou --im +bub > ubcabu+bub.txt 2>&1 &
...
nohup python -u HERec_spl.py --um +ucou --im +bcib > ubcabu+bcib.txt 2>&1 &
...
nohup python -u HERec_spl.py --um +ucou --im +bcab > ubcabu+bcab.txt 2>&1 &
